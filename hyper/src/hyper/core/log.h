...
namespace hp
{
	...
	{
		logger_->trace(std::forward <spdlog::format_string_t < Args...>>
	...
	{
		logger_->info(std::forward <spdlog::format_string_t < Args... >>
		(fmt), std::forward <Args>(args)...);
	}
	...
	{
		logger_->warn(std::forward <spdlog::format_string_t < Args... >>
		(fmt), std::forward <Args>(args)...);
	}
	...
	{
		logger_->error(std::forward <spdlog::format_string_t < Args... >>
		(fmt), std::forward <Args>(args)...);
	}
	...
	{
		logger_->critical(std::forward <spdlog::format_string_t < Args... >>
		(fmt), std::forward <Args>(args)...);
	}
}
